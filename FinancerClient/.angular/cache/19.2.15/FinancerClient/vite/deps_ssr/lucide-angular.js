...
// node_modules/lucide-angular/fesm2015/lucide-angular.mjs
var _c0 = ["*"];
var AArrowDown = [["path", {
  d: "m14 12 4 4 4-4",
  key: "buelq4"
...
var LucideAngularComponent = class {
  ...
  get size() {
    var _a;
    return (_a = this._size) !== null && _a !== void 0 ? _a : this.iconConfig.size;
  }
  set size(value) {
    if (value) {
  ...
  get strokeWidth() {
    var _a;
    return (_a = this._strokeWidth) !== null && _a !== void 0 ? _a : this.iconConfig.strokeWidth;
  }
  ...
  ngOnChanges(changes) {
    ...
    if (changes.name || changes.img || changes.color || changes.size || changes.absoluteStrokeWidth || changes.strokeWidth || changes.class) {
      this.color = (_a = this.color) !== null && _a !== void 0 ? _a : this.iconConfig.color;
      this.size = this.parseNumber((_b = this.size) !== null && _b !== void 0 ? _b : this.iconConfig.size);
      this.strokeWidth = this.parseNumber((_c = this.strokeWidth) !== null && _c !== void 0 ? _c : this.iconConfig.strokeWidth);
      this.absoluteStrokeWidth = (_d = this.absoluteStrokeWidth) !== null && _d !== void 0 ? _d : this.iconConfig.absoluteStrokeWidth;
      const nameOrIcon = (_e = this.img) !== null && _e !== void 0 ? _e : this.name;
  ...
  replaceElement(img) {
    var _a;
    const attributes = Object.assign(Object.assign({}, defaultAttributes), {
      width: this.size,
      height: this.size,
      stroke: (_a = this.color) !== null && _a !== void 0 ? _a : this.iconConfig.color,
...
var legacyIconProviderFactory = (icons) => {
  return new LucideIconProvider(icons !== null && icons !== void 0 ? icons : {});
};
